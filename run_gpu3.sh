python -m torch.distributed.launch --nproc_per_node=1 --master_port=12340 train.py \
    ...
    --size=128 \
    --channel=-1 \
    --check_save=/root/Data/non_IID/encoder/rxrx19a_VERO/
...
python -m torch.distributed.launch --nproc_per_node=1 --master_port=12340 train.py \
    ...
    --size=128 \
    --channel=3 \
    --check_save=/root/Data/non_IID/encoder/rxrx19a_HRCE_chn3/
...
python -m torch.distributed.launch --nproc_per_node=1 --master_port=12340 train.py \
    ...
    --size=128 \
    --channel=3 \
    --check_save=/root/Data/non_IID/encoder/rxrx19a_VERO_chn3/